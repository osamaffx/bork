...
The currently supported commands are "profile", "arena", "energy", and "ability".  When you enter a command, you only have to enter enough of the letters to uniquely specify it.
